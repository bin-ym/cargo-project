...
const API_URL = '/cargo-project/backend/api/requests/index.php?status=approved';
...
function renderTable() {
    ...
    if (filteredData.length === 0) {
        body.innerHTML = `<tr><td colspan="7" style="text-align:center; padding: 20px;">No approved requests found</td></tr>`;
    ...
    paginated.forEach(row => {
        ...
        <tr>
            ...
            <td class="row-action">
                <a href="order_items.php?id=${row.eid}" class="btn-small btn-view">View Items</a>
            </td>
        </tr>`;
    });
