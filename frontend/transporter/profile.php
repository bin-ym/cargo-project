            ...
            <div class="recent-activity" style="max-width: 600px;">
                ...
                <form style="margin-top: 20px;">
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <input type="text" placeholder="e.g., Isuzu FSR" style="width: 100%; padding: 12px; border: 1px solid #e2e8f0; border-radius: 8px;">
                    </div>
                    <div style="margin-bottom: 20px;">
                        <label style="display: block; margin-bottom: 8px; font-weight: 600; color: #334155;">Plate Number</label>
                        <input type="text" placeholder="e.g., ABC-123" style="width: 100%; padding: 12px; border: 1px solid #e2e8f0; border-radius: 8px;">
                    </div>
